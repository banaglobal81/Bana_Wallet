...
export default function BanaLogo({ className = '', size = 'md' }: BanaLogoProps) {
  const dimensions = {
    sm: { box: 'w-8 h-8', textTitle: 'text-xl', textSub: 'text-[11px]' },
    md: { box: 'w-10 h-10', textTitle: 'text-3xl', textSub: 'text-[13px]' },
    lg: { box: 'w-14 h-14', textTitle: 'text-4xl', textSub: 'text-[15px]' },
  };
