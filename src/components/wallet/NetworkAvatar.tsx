...
// Network code → chain icon filename in /public/coins. Codes not listed fall back
// to a colored initial (e.g. L2s like ARB/OP/BASE/SCROLL that share no chain icon).
